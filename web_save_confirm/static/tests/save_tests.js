odoo.define("web_save_confirm.confirm_tests", function (require) {
    "use strict";
    ...
    QUnit.module(
        ...
        function () {
            QUnit.test("ask confirmation before save", async function (assert) {
                assert.expect(4);
                ...
                // Trigger onSaveRecordConfirm
                await form._onSaveRecordConfirm();
